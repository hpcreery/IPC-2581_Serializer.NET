...
public static class IPC2581Schema
{
  public const string NameSpace = "http://webstds.ipc.org/2581";
  public const string RevA =
    @"<?xml version='1.0' encoding='UTF-8'?>
<!-- Schema File for IPC-2581 revision A (IPC internal reference IPC-2581A_V2.0.xsd) -->
<xsd:schema xmlns='http://webstds.ipc.org/2581' xmlns:tn='http://webstds.ipc.org/2581' xmlns:xsd='http://www.w3.org/2001/XMLSchema' targetNamespace='http://webstds.ipc.org/2581'>
	...
	<xsd:simpleType name='stackImpedanceType'>
		<xsd:restriction base='xsd:string'>
			...
			<xsd:enumeration value='DIFFERENTIAL_PAIR'/>
			<xsd:enumeration value='EMBEDDED_MICROSTRIP'/>
	...
	<xsd:complexType name='AvlItemType'>
		...
		<xsd:attribute name='OEMDesignNumber' type='qualifiedNameType' use='required'/>
	</xsd:complexType>
	...
	<xsd:complexType name='AvlVmpnType'>
		...
		<xsd:attribute name='qualified' type='xsd:boolean' use='required'/>
		<xsd:attribute name='chosen' type='xsd:boolean' use='required'/>
	</xsd:complexType>
	...
	<xsd:complexType name='BomHeaderType'>
		<xsd:sequence>
			<xsd:element ref='StepRef' maxOccurs='unbounded'/>
		</xsd:sequence>
		<xsd:attribute name='assembly' type='qualifiedNameType' use='required'/>
	...
	<xsd:complexType name='BomItemType'>
		<xsd:sequence>
			<xsd:element ref='RefDes' minOccurs='0' maxOccurs='unbounded'/>
			<xsd:element ref='Characteristics'/>
		</xsd:sequence>
		<xsd:attribute name='OEMDesignNumberRef' type='qualifiedNameType' use='required'/>
		<xsd:attribute name='quantity' type='xsd:string' use='required'/>
		<xsd:attribute name='numberIO' type='xsd:nonNegativeInteger' use='required'/>
	...
	<xsd:complexType name='BooleanAttributeType'>
		<xsd:attribute name='name' type='booleanAttributeName' use='required'/>
	...
	<xsd:complexType name='CadHeaderType'>
		<xsd:sequence>
			...
			<xsd:element ref='SurfaceFinish' minOccurs='0' maxOccurs='unbounded'/>
	...
	<xsd:complexType name='CadVmpnType'>
		<xsd:attribute name='cadMpn' type='xsd:string' use='required'/>
		<xsd:attribute name='cadAvlVendor' type='xsd:string' use='required'/>
	...
	<xsd:complexType name='ComponentType'>
		...
		<xsd:attribute name='refDes' type='qualifiedNameType' use='required'/>
		<xsd:attribute name='packageRef' type='qualifiedNameType' use='required'/>
	...
	<xsd:complexType name='ContentType'>
		<xsd:sequence>
			<xsd:element ref='FunctionMode' maxOccurs='unbounded'/>
			<xsd:element ref='StepRef' maxOccurs='unbounded'/>
	...
	<xsd:complexType name='DfxMeasurementListType'>
		...
		<xsd:attribute name='criteria' type='xsd:double' use='required'/>
	</xsd:complexType>
	<xsd:complexType name='DfxMeasurementType'>
		...
		<xsd:attribute name='unitMode' type='unitModeType' use='required'/>
	</xsd:complexType>
	...
	<xsd:complexType name='DoubleAttributeType'>
		<xsd:attribute name='name' type='doubleAttributeName' use='required'/>
		<xsd:attribute name='value' type='xsd:double' use='required'/>
	</xsd:complexType>
	<xsd:element name='DrillTool' type='DrillToolType'/>
	<xsd:complexType name='DrillToolType'>
		<xsd:attribute name='id' type='xsd:string' use='required'/>
		<xsd:attribute name='type' type='drillType' use='required'/>
		...
		<xsd:attribute name='finishSize' type='nonNegativeDoubleType' use='required'/>
		<xsd:attribute name='drillSize' type='xsd:string' use='required'/>
	</xsd:complexType>
	...
	<xsd:complexType name='FontDefExternalType'>
		<xsd:attribute name='name' type='xsd:string' use='required'/>
		<xsd:attribute name='urn' type='urn' use='required'/>
	</xsd:complexType>
	...
	<xsd:complexType name='IntegerAttributeType'>
		<xsd:attribute name='name' type='integerAttributeName' use='required'/>
	...
	<xsd:element name='IPC-2581' type='IPC-2581Type'>
		...
		<xsd:keyref name='stepKeyRef' refer='stepKey'>
			<xsd:selector xpath='.//tn:StepRepeat|.//tn:BomHeader'/>
		...
		<xsd:key name='OEMDesignNumberKey'>
			<xsd:selector xpath='tn:Avl/tn:AvlItem'/>
			<xsd:field xpath='@OEMDesignNumber'/>
		</xsd:key>
		<xsd:keyref name='OEMDesignNumberKeyRef' refer='OEMDesignNumberKey'>
			<xsd:selector xpath='.//tn:BomItem'/>
		...
		<xsd:keyref name='layerKeyRef' refer='layerKey'>
			...
			<xsd:selector xpath='.//tn:Component|.//tn:FeatureDescription|.//tn:LayerFeature|.//tn:LayerPad|.//tn:PhyNetPoint|.//tn:SurfaceFinish'/>
		...
		<xsd:key name='componentKey'>
			<xsd:selector xpath='tn:Ecad/tn:CadData/tn:Step/tn:Component'/>
			<xsd:field xpath='@refDes'/>
		</xsd:key>
		<xsd:keyref name='componentKeyRef' refer='componentKey'>
			<xsd:selector xpath='.//tn:LogicalNetPin'/>
			<xsd:field xpath='@componentRef'/>
		</xsd:keyref>
		<xsd:keyref name='ComponentKeyRef' refer='componentKey'>
			<xsd:selector xpath='.//tn:RefDes'/>
			<xsd:field xpath='@name'/>
		</xsd:keyref>
		...
		<xsd:key name='toolNumberKey'>
			<xsd:selector xpath='tn:Ecad/tn:CadData/tn:Layer/tn:DrillTool'/>
			<xsd:field xpath='@id'/>
		</xsd:key>
		<xsd:keyref name='toolNumberKeyRef' refer='toolNumberKey'>
			<xsd:selector xpath='.//tn:Set'/>
			<xsd:field xpath='@toolIdRef'/>
		</xsd:keyref>
		<xsd:key name='bomItemKey'>
			<xsd:selector xpath='tn:Bom/tn:BomItem'/>
			<xsd:field xpath='@OEMDesignNumberRef'/>
		</xsd:key>
		<xsd:keyref name='bomItemKeyRef' refer='bomItemKey'>
			<xsd:selector xpath='.//tn:VplComponent'/>
			<xsd:field xpath='@bomItemRef'/>
		</xsd:keyref>
		<xsd:key name='vplPackageKey'>
			<xsd:selector xpath='tn:Ecad/tn:CadData/tn:Step/tn:VplPackage'/>
			<xsd:field xpath='@name'/>
		</xsd:key>
		<xsd:keyref name='vplPackageKeyRef' refer='vplPackageKey'>
			<xsd:selector xpath='.//tn:VplComponent'/>
			<xsd:field xpath='@vplPackageRef'/>
		</xsd:keyref>
		...
		<xsd:keyref name='layerOrGroupKeyRef' refer='layerOrStackupGroupNameKey'>
			<xsd:selector xpath='.//tn:StackupLayer'/>
	...
	<xsd:complexType name='OptionAttributeType'>
		<xsd:attribute name='name' type='optionAttributeName' use='required'/>
		<xsd:attribute name='value' type='optionValue' use='required'/>
	</xsd:complexType>
	...
	<xsd:complexType name='PinRefType'>
		<xsd:attribute name='componentRef' type='qualifiedNameType' use='required'/>
	...
	<xsd:complexType name='PolyStepCurveType'>
		...
		<xsd:attribute name='centerX' type='xsd:double' use='required'/>
		<xsd:attribute name='centerY' type='xsd:double' use='required'/>
		<xsd:attribute name='clockwise' type='xsd:boolean' default='true'/>
	</xsd:complexType>
	...
	<xsd:complexType name='SetType'>
		...
		<xsd:attribute name='toolIdRef' type='xsd:string'/>
	</xsd:complexType>
	...
	<xsd:complexType name='SpecType'>
		...
		<xsd:attribute name='tolPlus' type='nonNegativeDoubleType' use='required'/>
		<xsd:attribute name='tolMinus' type='nonNegativeDoubleType' use='required'/>
		<xsd:attribute name='global' type='xsd:boolean' use='required'/>
		<xsd:attribute name='comment' type='xsd:string'/>
	</xsd:complexType>
	...
	<xsd:complexType name='StackupImpedanceType'>
		...
		<xsd:attribute name='value' type='nonNegativeDoubleType' use='required'/>
		<xsd:attribute name='type' type='stackImpedanceType' use='required'/>
		<xsd:attribute name='tolPlus' type='nonNegativeDoubleType' use='required'/>
		<xsd:attribute name='tolMinus' type='nonNegativeDoubleType' use='required'/>
		<xsd:attribute name='introduction' type='xsd:string' use='required'/>
	</xsd:complexType>
	...
	<xsd:complexType name='StepRepeatType'>
		<xsd:attribute name='stepRef' type='qualifiedNameType' use='required'/>
		<xsd:attribute name='x' type='xsd:double' use='required'/>
		<xsd:attribute name='y' type='xsd:double' use='required'/>
	...
	<xsd:complexType name='TextAttributeType'>
		<xsd:attribute name='name' type='textAttributeName' use='required'/>
		<xsd:attribute name='value' type='xsd:string' use='required'/>
	</xsd:complexType>
	...
	<xsd:complexType name='VplComponentType'>
		...
		<xsd:attribute name='componentRef' type='qualifiedNameType' use='required'/>
		<xsd:attribute name='bomItemRef' type='qualifiedNameType' use='required'/>
		<xsd:attribute name='vplPackageRef' type='qualifiedNameType'/>
	</xsd:complexType>
...
";
  public const string RevB =
    @"<?xml version='1.0' encoding='UTF-8'?>
<!-- Schema File for IPC-2581 revision B (IPC internal reference IPC-2581B_V3.0.xsd)  -->
<xsd:schema xmlns='http://webstds.ipc.org/2581' xmlns:tn='http://webstds.ipc.org/2581' xmlns:xsd='http://www.w3.org/2001/XMLSchema' targetNamespace='http://webstds.ipc.org/2581'>
	<xsd:simpleType name='angleType'>
		<xsd:restriction base='xsd:decimal'>
			<xsd:minInclusive value='0.00'/>
	...
	<xsd:simpleType name='dielectricListType'>
		<xsd:restriction base='xsd:string'>
			...
			<xsd:enumeration value='GLASS_TYPE'/>
			<xsd:enumeration value='GLASS_STYLE'/>
			<xsd:enumeration value='RESIN_CONTENT'/>
			<xsd:enumeration value='PROCESSABILITY_TEMP'/>
			<xsd:enumeration value='OTHER'/>
		</xsd:restriction>
	</xsd:simpleType>
	<xsd:simpleType name='donutShapeType'>
	...
	<xsd:simpleType name='structureListType'>
		<xsd:restriction base='xsd:string'>
			<xsd:enumeration value='STRIPLINE'/>
			<xsd:enumeration value='PLANE_LESS_STRIPLINE '/>
	...
	<xsd:complexType name='DiamondType'>
		<xsd:sequence>
			<xsd:element ref='Xform' minOccurs='0'/>
			<xsd:element ref='LineDesc' minOccurs='0'/>
			<xsd:element ref='FillDesc' minOccurs='0'/>
		</xsd:sequence>
		<xsd:attribute name='width' type='nonNegativeDoubleType' use='required'/>
		<xsd:attribute name='height' type='nonNegativeDoubleType' use='required'/>
	</xsd:complexType>
	...
	<xsd:complexType name='ConductorType'>
		...
		<xsd:attribute name='type' type='conductorListType' use='required'/>
		<xsd:attribute name='comment' type='xsd:string' use='optional'/>
	</xsd:complexType>
	...
	<xsd:complexType name='ImpedanceType'>
		...
		<xsd:attribute name='type' type='impedanceListType' use='required'/>
		<xsd:attribute name='transmission' type='transmissionListType' use='required'/>
	...
	<xsd:complexType name='PropertyType'>
		...
		<xsd:attribute name='tolPercent' type='xsd:boolean' use='optional'/>
	...
	<xsd:complexType name='StackupLayerType'>
		...
		<xsd:attribute name='refDes' type='qualifiedNameType'/>
		<xsd:attribute name='comment' type='xsd:string'/>
	</xsd:complexType>
...
";
  ...
  public const string RevB1 =
    @"<?xml version='1.0' encoding='UTF-8'?>
<!-- Schema File for IPC-2581 revision B1  (revision B ammendment 1) -->
<xsd:schema xmlns='http://webstds.ipc.org/2581' xmlns:tn='http://webstds.ipc.org/2581' xmlns:xsd='http://www.w3.org/2001/XMLSchema' targetNamespace='http://webstds.ipc.org/2581'>
	<xsd:simpleType name='angleType'>
		<xsd:restriction base='xsd:decimal'>
			<xsd:minInclusive value='0.00'/>
	...
	<xsd:complexType name='AvlItemType'>
		...
		<xsd:attribute name='OEMDesignNumber' type='shortName' use='required'/>
	</xsd:complexType>
	<xsd:element name='AvlMpn' type='AvlMpnType'/>
	<xsd:complexType name='AvlMpnType'>
		<xsd:attribute name='name' type='qualifiedNameType' use='required'/>
	...
	<xsd:complexType name='BomHeaderType'>
		...
		<xsd:attribute name='assembly' type='shortName' use='required'/>
		<xsd:attribute name='revision' type='xsd:string' use='required'/>
		<xsd:attribute name='affecting' type='xsd:boolean'/>
	</xsd:complexType>
	<xsd:element name='BomItem' type='BomItemType'/>
	<xsd:complexType name='BomItemType'>
		...
		<xsd:attribute name='OEMDesignNumberRef' type='shortName' use='required'/>
		<xsd:attribute name='quantity' type='xsd:string' use='required'/>
		<xsd:attribute name='pinCount' type='xsd:nonNegativeInteger' use='optional'/>
		<xsd:attribute name='category' type='bomCategoryType' use='required'/>
		<xsd:attribute name='internalPartNumber' type='xsd:string'/>
	...
	<xsd:element name='BomRef' type='BomRefType'/>
	<xsd:complexType name='BomRefType'>
		<xsd:attribute name='name' type='shortName' use='required'/>
	</xsd:complexType>
	<xsd:complexType name='BomType'>
		<xsd:sequence>
			<xsd:element ref='BomHeader'/>
	...
	<xsd:complexType name='StackupGroupType'>
		<xsd:sequence>
			<xsd:element ref='StackupLayer' minOccurs='0' maxOccurs='unbounded'/>
			<xsd:element ref='CADDataLayerRef' minOccurs='0' maxOccurs='unbounded'/>
			<xsd:element ref='MatDes' minOccurs='0'/>
			<xsd:element ref='SpecRef' minOccurs='0' maxOccurs='unbounded'/>
		</xsd:sequence>
		<xsd:attribute name='name' type='qualifiedNameType' use='required'/>
		<xsd:attribute name='thickness' type='nonNegativeDoubleType' use='required'/>
	...
	<xsd:element name='StepRepeat' type='StepRepeatType'/>
	<xsd:complexType name='StepRepeatType'>
		<xsd:attribute name='stepRef' type='shortName' use='required'/>
		<xsd:attribute name='x' type='xsd:double' use='required'/>
		<xsd:attribute name='y' type='xsd:double' use='required'/>
		<xsd:attribute name='nx' type='xsd:nonNegativeInteger' use='required'/>
		<xsd:attribute name='ny' type='xsd:nonNegativeInteger' use='required'/>
